...
namespace SmartDietAPI.Controllers
{
    ...
    public class DishController : Controller
    {
        ...
        [HttpGet("all")]
        public async Task<IActionResult> GetDishes([FromQuery] int pageIndex = 1, [FromQuery] int pageSize = 10, [FromQuery] string? searchTearm = null)
        {
            var result = await _dishService.GetAllDishesAsync(pageIndex, pageSize, searchTearm);
